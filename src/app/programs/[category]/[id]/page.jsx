    ...
    communityoutreach: [
      {
        ...
        title: "Great Lakes Chapter Community Outreach",
        description: "Organizing skill-building and leadership development workshops for community members.",
        location: "Bamenda, Cameroon",
        date: "October 2025",
        organizer: "BMCA Great Lakes Chapter",
        image: "/outreach2.png",
        badge: "Completed",
        fullDescription: "The Great Lakes Chapter of BMCA organized a comprehensive community outreach program in October 2025, bringing together diaspora volunteers to conduct skill-building workshops, leadership development sessions, and community engagement activities for residents of Bamenda, Cameroon. This initiative successfully connected community members with valuable resources and training opportunities while strengthening ties between the diaspora and local communities.",
        goals: [
          "Conduct skill-building workshops for 150+ community members",
          "Develop leadership capacity among 50+ youth participants",
          "Facilitate cultural exchange between diaspora and local community",
          "Provide vocational training in practical skills",
          "Establish mentorship connections for ongoing support"
        ],
        impact: "Empowered 200+ community members with new skills and leadership capabilities, creating lasting connections between the Great Lakes diaspora chapter and local organizations in Bamenda.",
        budget: "$15,000",
        duration: "2 Weeks",
        participants: "200+ community members + 25 diaspora volunteers",
        videos: [
          "dQw4w9WgXcQ",
          "3JZ_D3ELwOQ"
        ],
        bmcaDescription: "BMCA (Bafut Manjong Cultural Association) is dedicated to empowering communities through education, healthcare, water access, and infrastructure development. Our mission is to create sustainable change by addressing fundamental needs and fostering community growth in the Northwest region of Cameroon.",
        programBenefits: "This community outreach program provided participants with practical skills for economic self-sufficiency, leadership training for community organizing, and strengthened the cultural connections between diaspora members and their home community. Participants gained confidence, practical knowledge, and ongoing support networks."
      }
    ],
  }
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <span
                className={`inline-block px-4 py-2 rounded-full text-sm font-semibold ${program.badge === "Events"
